    ...
    return (
        <div>
            <div className="File_upload_modal">
                <h1 className='text-20 font-bold mb-20'>Upload Student Documents To Get It Verified</h1>
                {
                    files.length > 0 ?
                ...
                <div className="user">
                    <div className="label text-14 font-semibold mt-10 mb-6">Enter users email</div>
                    <input type="text" placeholder='Enter users email' className='bg-neutral-100 py-10 px-10 rounded-8 w-[40rem] text-center text-13' />
                </div>
